// Chart tokens for this dashboard.
//
// Deliberately duplicated rather than shared: the two frontends are separate
// apps with separate builds, and a shared package was weighed and rejected.
// What is NOT optional is keeping the duplicates in step --
// open-finance/frontend/src/App.css is the authority for every value in INK,
// FONT_SANS, FONT_MONO and TOOLTIP below, and its
// frontend/src/utils/chartTheme.js holds the same four in the same shape.
// Change one, change both.
//
// `fmtSigned` / `fmtPct` at the bottom are the same functions as
// `formatSigned` / `formatPercent` in open-finance's frontend/src/utils/format.js,
// minus the currency handling this project has no use for. Same caveat.
//
